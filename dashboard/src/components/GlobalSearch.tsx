  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:border-blue-500/40 hover:text-foreground"
      >
