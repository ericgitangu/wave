...
import { ArrowRight, Award, GitBranch, Globe, Timer } from 'lucide-react'
...
const stats = [
  ...
  { label: 'Years in Africa', value: '7', icon: Globe, color: '#d97706' },
]
        ...
        >
          ...
          <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur-sm">
            ...
            <p className="leading-relaxed text-muted-foreground">
              ...
              solar PAYG platforms, and multilingual applications. Native Swahili speaker with
              hands-on experience in low-resource language environments -- the exact challenges
              Wave faces daily.
            </p>
          </div>
        </motion.section>
